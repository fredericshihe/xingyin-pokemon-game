...
export const MONSTERS = [
  ...
  {
    id: 123, dexNo: 12, name: '巴大蝶',
    type: TYPES.BUG, type2: TYPES.FLYING,
    maxHp: 60, maxMp: 92, atk: 45, def: 50, spAtk: 90, spDef: 80, spd: 70,
    moves: ['peck', 'razorleaf', 'psychic', 'hurricane'],
    ...sp(12),
  },
  {
  ...
  {
    id: 150, dexNo: 15, name: '大针蜂',
    type: TYPES.BUG, type2: TYPES.POISON,
    maxHp: 65, maxMp: 56, atk: 90, def: 40, spAtk: 45, spDef: 80, spd: 75,
    moves: ['fury_attack', 'poison_jab', 'double_kick', 'rock_slide'],
    ...sp(15),
  },
  {
    id: 151, dexNo: 16, name: '波波',
    type: TYPES.NORMAL, type2: TYPES.FLYING,
    maxHp: 40, maxMp: 48, atk: 45, def: 40, spAtk: 35, spDef: 35, spd: 56,
    moves: ['tackle', 'peck', 'quickattack'],
    evolvesTo: { level: 18, targetId: 152 },
    ...sp(16),
  },
  {
    id: 152, dexNo: 17, name: '比比鸟',
    type: TYPES.NORMAL, type2: TYPES.FLYING,
    maxHp: 63, maxMp: 60, atk: 60, def: 55, spAtk: 50, spDef: 50, spd: 71,
    moves: ['peck', 'wing_attack', 'quickattack', 'fly'],
    evolvesTo: { level: 36, targetId: 153 },
    ...sp(17),
  },
  {
    id: 153, dexNo: 18, name: '大比鸟',
    type: TYPES.NORMAL, type2: TYPES.FLYING,
    maxHp: 83, maxMp: 76, atk: 80, def: 75, spAtk: 70, spDef: 70, spd: 101,
    moves: ['wing_attack', 'fly', 'drill_peck', 'hurricane'],
    ...sp(18),
  },
  {
    id: 154, dexNo: 19, name: '小拉达',
    type: TYPES.NORMAL,
    maxHp: 30, maxMp: 40, atk: 56, def: 35, spAtk: 25, spDef: 35, spd: 72,
    moves: ['tackle', 'quickattack', 'bite'],
    evolvesTo: { level: 20, targetId: 155 },
    ...sp(19),
  },
  {
    id: 155, dexNo: 20, name: '拉达',
    type: TYPES.NORMAL,
    maxHp: 55, maxMp: 60, atk: 81, def: 60, spAtk: 50, spDef: 70, spd: 97,
    moves: ['quickattack', 'bite', 'bodyslam', 'slash'],
    ...sp(20),
  },
  {
    id: 156, dexNo: 21, name: '烈雀',
    type: TYPES.NORMAL, type2: TYPES.FLYING,
    maxHp: 40, maxMp: 44, atk: 60, def: 30, spAtk: 31, spDef: 31, spd: 70,
    moves: ['peck', 'quickattack', 'fury_attack'],
    evolvesTo: { level: 20, targetId: 157 },
    ...sp(21),
  },
  {
    id: 157, dexNo: 22, name: '大嘴雀',
    type: TYPES.NORMAL, type2: TYPES.FLYING,
    maxHp: 65, maxMp: 68, atk: 90, def: 65, spAtk: 61, spDef: 61, spd: 100,
    moves: ['drill_peck', 'wing_attack', 'fly', 'sky_attack'],
    ...sp(22),
  },
  {
    id: 158, dexNo: 23, name: '阿柏蛇',
    type: TYPES.POISON,
    maxHp: 35, maxMp: 52, atk: 60, def: 44, spAtk: 40, spDef: 54, spd: 55,
    moves: ['poison_sting', 'bite', 'rollout'],
    evolvesTo: { level: 22, targetId: 159 },
    ...sp(23),
  },
  {
    id: 159, dexNo: 24, name: '阿柏怪',
    type: TYPES.POISON,
    maxHp: 60, maxMp: 72, atk: 95, def: 69, spAtk: 65, spDef: 79, spd: 80,
    moves: ['poison_jab', 'bite', 'slash', 'rock_slide'],
    ...sp(24),
  },
  {
    id: 160, dexNo: 27, name: '穿山鼠',
    type: TYPES.GROUND,
    maxHp: 50, maxMp: 36, atk: 75, def: 85, spAtk: 20, spDef: 30, spd: 40,
    moves: ['scratch', 'rollout', 'rock_throw'],
    evolvesTo: { level: 22, targetId: 161 },
    ...sp(27),
  },
  {
    id: 161, dexNo: 28, name: '穿山王',
    type: TYPES.GROUND,
    maxHp: 75, maxMp: 56, atk: 100, def: 110, spAtk: 45, spDef: 55, spd: 65,
    moves: ['slash', 'earthquake', 'rock_slide', 'rollout'],
    ...sp(28),
  },
  {
    id: 162, dexNo: 29, name: '尼多兰',
    type: TYPES.POISON,
    maxHp: 55, maxMp: 52, atk: 47, def: 52, spAtk: 40, spDef: 40, spd: 41,
    moves: ['scratch', 'poison_sting', 'double_kick'],
    evolvesTo: { level: 16, targetId: 163 },
    ...sp(29),
  },
  {
    id: 163, dexNo: 30, name: '尼多娜',
    type: TYPES.POISON,
    maxHp: 70, maxMp: 64, atk: 62, def: 67, spAtk: 55, spDef: 55, spd: 56,
    moves: ['poison_sting', 'double_kick', 'bite', 'bodyslam'],
    evolvesTo: { level: 32, targetId: 164 },
    ...sp(30),
  },
  {
    id: 164, dexNo: 31, name: '尼多后',
    type: TYPES.POISON, type2: TYPES.GROUND,
    maxHp: 90, maxMp: 80, atk: 92, def: 87, spAtk: 75, spDef: 85, spd: 76,
    moves: ['poison_jab', 'earthquake', 'bodyslam', 'double_kick'],
    ...sp(31),
  },
  {
    id: 165, dexNo: 35, name: '皮皮',
    type: TYPES.FAIRY,
    maxHp: 70, maxMp: 68, atk: 45, def: 48, spAtk: 60, spDef: 65, spd: 35,
    moves: ['pound', 'moonblast', 'bodyslam'],
    evolvesTo: { level: 28, targetId: 166 },
    ...sp(35),
  },
  {
    id: 166, dexNo: 36, name: '皮可西',
    type: TYPES.FAIRY,
  ...
  {
    id: 167, dexNo: 41, name: '超音蝠',
    type: TYPES.POISON, type2: TYPES.FLYING,
    maxHp: 40, maxMp: 44, atk: 45, def: 35, spAtk: 30, spDef: 40, spd: 55,
    moves: ['bite', 'wing_attack', 'quickattack'],
    evolvesTo: { level: 22, targetId: 168 },
    ...sp(41),
  },
  {
    id: 168, dexNo: 42, name: '大嘴蝠',
    type: TYPES.POISON, type2: TYPES.FLYING,
  ...
  {
    id: 169, dexNo: 43, name: '走路草',
    type: TYPES.GRASS, type2: TYPES.POISON,
    maxHp: 45, maxMp: 80, atk: 50, def: 55, spAtk: 75, spDef: 65, spd: 30,
    moves: ['vinewhip', 'poison_sting', 'razorleaf'],
    evolvesTo: { level: 21, targetId: 87 },
    ...sp(43),
  },
  {
    id: 170, dexNo: 46, name: '派拉斯',
    type: TYPES.BUG, type2: TYPES.GRASS,
    maxHp: 35, maxMp: 56, atk: 70, def: 55, spAtk: 45, spDef: 55, spd: 25,
    moves: ['scratch', 'fury_cutter', 'poison_sting'],
    evolvesTo: { level: 24, targetId: 171 },
    ...sp(46),
  },
  {
    id: 171, dexNo: 47, name: '派拉斯特',
    type: TYPES.BUG, type2: TYPES.GRASS,
    maxHp: 60, maxMp: 68, atk: 95, def: 80, spAtk: 60, spDef: 80, spd: 30,
    moves: ['slash', 'fury_cutter', 'poison_jab', 'razorleaf'],
    ...sp(47),
  },
  {
    id: 172, dexNo: 48, name: '毛球',
    type: TYPES.BUG, type2: TYPES.POISON,
    maxHp: 60, maxMp: 52, atk: 55, def: 50, spAtk: 40, spDef: 55, spd: 45,
    moves: ['tackle', 'poison_sting', 'fury_cutter'],
    evolvesTo: { level: 31, targetId: 173 },
    ...sp(48),
  },
  {
    id: 173, dexNo: 49, name: '摩鲁蛾',
    type: TYPES.BUG, type2: TYPES.POISON,
    maxHp: 70, maxMp: 92, atk: 45, def: 50, spAtk: 90, spDef: 75, spd: 66,
    moves: ['psychic', 'poison_jab', 'razorleaf', 'hurricane'],
    ...sp(49),
  },
  {
    id: 174, dexNo: 50, name: '地鼠',
    type: TYPES.GROUND,
    maxHp: 10, maxMp: 48, atk: 55, def: 25, spAtk: 35, spDef: 45, spd: 95,
    moves: ['scratch', 'rock_throw', 'quickattack'],
    evolvesTo: { level: 26, targetId: 175 },
    ...sp(50),
  },
  {
    id: 175, dexNo: 51, name: '三地鼠',
    type: TYPES.GROUND,
    maxHp: 35, maxMp: 60, atk: 100, def: 50, spAtk: 50, spDef: 70, spd: 120,
    moves: ['earthquake', 'slash', 'rock_slide', 'quickattack'],
    ...sp(51),
  },
  {
    id: 176, dexNo: 60, name: '蚊香蝌蚪',
    type: TYPES.WATER,
    maxHp: 40, maxMp: 52, atk: 50, def: 40, spAtk: 40, spDef: 40, spd: 90,
    moves: ['watergun', 'tackle', 'flail'],
    evolvesTo: { level: 25, targetId: 177 },
    ...sp(60),
  },
  {
    id: 177, dexNo: 61, name: '蚊香君',
    type: TYPES.WATER,
    maxHp: 65, maxMp: 60, atk: 65, def: 65, spAtk: 50, spDef: 50, spd: 90,
    moves: ['watergun', 'bodyslam', 'surf'],
    evolvesTo: { level: 38, targetId: 33 },
    ...sp(61),
  },
  {
    id: 178, dexNo: 69, name: '喇叭芽',
    type: TYPES.GRASS, type2: TYPES.POISON,
    maxHp: 50, maxMp: 76, atk: 75, def: 35, spAtk: 70, spDef: 30, spd: 40,
    moves: ['vinewhip', 'poison_sting', 'razorleaf'],
    evolvesTo: { level: 21, targetId: 179 },
    ...sp(69),
  },
  {
    id: 179, dexNo: 70, name: '口呆花',
    type: TYPES.GRASS, type2: TYPES.POISON,
    maxHp: 65, maxMp: 88, atk: 90, def: 50, spAtk: 85, spDef: 45, spd: 55,
    moves: ['razorleaf', 'poison_jab', 'vinewhip'],
    evolvesTo: { level: 33, targetId: 180 },
    ...sp(70),
  },
  {
    id: 180, dexNo: 71, name: '大食花',
    type: TYPES.GRASS, type2: TYPES.POISON,
    maxHp: 80, maxMp: 100, atk: 105, def: 65, spAtk: 100, spDef: 70, spd: 70,
    moves: ['razorleaf', 'poison_jab', 'hydropump', 'vinewhip'],
    ...sp(71),
  },
  {
    id: 181, dexNo: 72, name: '玛瑙水母',
    type: TYPES.WATER, type2: TYPES.POISON,
    maxHp: 40, maxMp: 60, atk: 40, def: 35, spAtk: 50, spDef: 100, spd: 70,
    moves: ['watergun', 'poison_sting', 'flail'],
    evolvesTo: { level: 30, targetId: 182 },
    ...sp(72),
  },
  {
    id: 182, dexNo: 73, name: '毒刺水母',
    type: TYPES.WATER, type2: TYPES.POISON,
    maxHp: 80, maxMp: 84, atk: 70, def: 65, spAtk: 80, spDef: 120, spd: 100,
    moves: ['surf', 'poison_jab', 'icebeam', 'hydropump'],
    ...sp(73),
  },
  {
    id: 183, dexNo: 86, name: '小海狮',
    type: TYPES.WATER,
    maxHp: 65, maxMp: 56, atk: 45, def: 55, spAtk: 45, spDef: 70, spd: 45,
    moves: ['watergun', 'quickattack', 'icebeam'],
    evolvesTo: { level: 34, targetId: 40 },
    ...sp(86),
  },
  {
    id: 184, dexNo: 104, name: '卡拉卡拉',
    type: TYPES.GROUND,
    maxHp: 50, maxMp: 52, atk: 50, def: 95, spAtk: 40, spDef: 50, spd: 35,
    moves: ['rock_throw', 'bite', 'rollout'],
    evolvesTo: { level: 28, targetId: 47 },
    ...sp(104),
  },
  {
    id: 185, dexNo: 114, name: '蔓藤怪',
    type: TYPES.GRASS,
    maxHp: 65, maxMp: 100, atk: 55, def: 115, spAtk: 100, spDef: 40, spd: 60,
    moves: ['vinewhip', 'razorleaf', 'bodyslam', 'recover'],
    ...sp(114),
  },
  {
    id: 186, dexNo: 118, name: '角金鱼',
    type: TYPES.WATER,
    maxHp: 45, maxMp: 48, atk: 67, def: 60, spAtk: 35, spDef: 50, spd: 63,
    moves: ['peck', 'watergun', 'horn_attack'],
    evolvesTo: { level: 33, targetId: 187 },
    ...sp(118),
  },
  {
    id: 187, dexNo: 119, name: '金鱼王',
    type: TYPES.WATER,
    maxHp: 80, maxMp: 72, atk: 92, def: 65, spAtk: 65, spDef: 80, spd: 68,
    moves: ['surf', 'horn_attack', 'bodyslam', 'hydropump'],
    ...sp(119),
  },
  {
