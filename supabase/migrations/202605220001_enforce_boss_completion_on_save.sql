...
-- save. When a trainer battle carries a boss event identity and either reaches
-- victory or has no remaining enemy HP, the backend appends the map-scoped boss
